...
class StartWorkout extends StatelessWidget {
  CardItemModel cardItem;

  StartWorkout(this.cardItem, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text(cardItem.cardTitle),
          actions: <Widget>[
            Padding(
        ...
        body: new _StartWorkoutContents());
  }
}

class _StartWorkoutContents extends StatefulWidget {
  _StartWorkoutContents({Key key}) : super(key: key);

  @override
  _StartWorkoutContentsState createState() => new _StartWorkoutContentsState();
}

class _StartWorkoutContentsState extends State<_StartWorkoutContents> {
  ...
  Widget _createInfoPanelCell(IconData icon, String value, String description) {
    ...
    return new Container(
        ...
        child: new Center(
          ...
          new Icon(icon, size: 34.0, color: color),
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return new Stack(children: <Widget>[
              new _Fireworks(),
              new AlertDialog(
                title: new Text('That\'s an Awesome'),
                content: new Text(
                    'You have completed $_count times workout. Well going!'),
                actions: <Widget>[
                  new FlatButton(
                      child: new Text('Cool', style: TextStyle(color: Colors
                              .green[600]),),
                      onPressed: () {
